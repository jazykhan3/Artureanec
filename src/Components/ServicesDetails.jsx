...
function ServiceDetail() {
  ...
  return (
<div className="bg-[#fefbf0]">    <div className="flex items-center mx-10 pt-6 gap-2 font-bold cursor-pointer"           onClick={() => handleMenuItemClick("heroSection")}
><FiArrowLeft className="font-bold text-xl" /> Back</div><div className="px-10 py-6 md:p-40 flex flex-col md:flex-row gap-[20px] bg-[#fefbf0] items-start">
            <img src={selectedService.img} width={500} height={500} alt={selectedService.heading} />
